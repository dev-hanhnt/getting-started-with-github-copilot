...
activities = {
    ...
    "Basketball Team": {
        "description": "Team training and games for students who love basketball",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "maria@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim practice and competitions for all ability levels",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["nina@mergington.edu", "toby@mergington.edu"]
    },
    "Art Club": {
    ...
    "Math Olympiad": {
        "description": "Practice advanced problem solving and math competitions",
